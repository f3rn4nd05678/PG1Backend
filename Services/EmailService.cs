...
public interface IEmailService
{
    ...
    Task EnviarPasswordRecuperacion(string destinatario, string nombreUsuario, string passwordTemporal);
}
...
public class EmailService : IEmailService
{
    ...
    public async Task EnviarPasswordRecuperacion(
    string destinatario,
    string nombreUsuario,
    string passwordTemporal)
    {
        var asunto = "Recuperación de Contraseña - Sistema Plastihogar";
        ...
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
            <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;'>
                ...
                <div style='background-color: #f8f9fa; padding: 15px; border-left: 4px solid #007bff; margin: 20px 0;'>
                    <h3 style='margin-top: 0; color: #007bff;'>Nueva Contraseña Temporal</h3>
                    <p><strong>Usuario (Correo):</strong> {destinatario}</p>
                    <p><strong>Contraseña Temporal:</strong> <code style='background: #e9ecef; padding: 5px 10px; border-radius: 3px; font-size: 14px;'>{passwordTemporal}</code></p>
                </div>
                ...
                <p style='margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #666; font-size: 12px;'>
                    ...
                    Contacta al administrador del sistema de inmediato.
                </p>
